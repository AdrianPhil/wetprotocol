...
class OntologyTest {
	...
	private void testCreateIndividualAndAssignLiteralAndClassPropertyValues() {
		Individual newlyCreatedIndividual = ontologyManager.createIndividual("myCodeCreatedMicroCentrifugeTube", OntologyManager.NS + "MicroCentrifugeTube");
		...
		OntProperty stringValueProperty = ontologyModel.getOntProperty(OntologyManager.NS + "manufacturer");
	...
	public PropertyAndIndividual getTopPropertyAndIndividual() {
		if (TOP_PROPERTY_AND_INDIVIDUAL == null) {
			Individual dummyIndividual = ontologyModel.getIndividual(OntologyManager.NS + "dummyIndividual");
			TOP_PROPERTY_AND_INDIVIDUAL = new PropertyAndIndividual(ontologyModel.getOntProperty(OntologyManager.NS + "dummyDataProperty"), dummyIndividual, NodeType.DUMMY_INDIVIDUAL);
